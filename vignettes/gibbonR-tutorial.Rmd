...
```
## Part 3c. Calculate performance metrics using 'ROCR'
...
## Part 3d. Plot performance metrics

```{r }
# AUCbox <- ggboxplot(data=auc.df,
#           x='TrainingData',y='AUC',fill='TrainingData',facet.by = 'ml.algorithm')+ theme(axis.text.x = element_text(angle = 45,  hjust=1))+
