...
#' @param num.cep Number of cepstra to return when calculating Mel-frequency cepstral coefficients
...
DetectSVM <-
  function(wav.file,
    ...
    return(
      list(
        svm.accuracy = svm.model$tot.accuracy,
        detection.df = detection.df,
